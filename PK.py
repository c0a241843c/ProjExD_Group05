...
class Keeper:
    def __init__(self, goal):
        ...
        self.kippaa_jyoukyou = "genzai"  # "genzai", "taoshi", "kieta"
...
def main():
    ...
    while running:
        ...
        elif keeper.kippaa_jyoukyou == "taoshi":
        ...
        if goal_scored:
            ...
            draw_text(screen, "KEEPER HAKAI!", font, YELLOW, WIDTH // 2 - 150, HEIGHT // 2)
